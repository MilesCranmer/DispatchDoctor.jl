...
4. **Within certain code blocks and function types:**
	...
	- A function inside another function (a closure) - **unless `include_closures=true` is specified**.
		...
		- To also stabilize closures, use `@stable include_closures=true function f(x) ... end`
